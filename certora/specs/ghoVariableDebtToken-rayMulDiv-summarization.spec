...
/*================================================================================
  Calling to mint(...amount) can't increase the balance by more than sclaed-amount.
...
/*================================================================================
  When calling Calling updateDiscountDistribution, if discountScaled>0 then the 
...
/*================================================================================
  When calling Calling updateDiscountDistribution, the argumet 'amount' has influence
